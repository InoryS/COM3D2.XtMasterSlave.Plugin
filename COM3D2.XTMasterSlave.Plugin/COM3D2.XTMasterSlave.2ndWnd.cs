                ...
                try
                {
                    ...
                    if (GUI.Button(new Rect(ItemX, pos_y += ItemHeight, ItemWidth, ItemHeight), "保存", gsButton))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                cfgs[i].v3StackOffsetFA = XtMasterSlave.v3Tofa(v3ofs[i].v3StackOffset);
                                cfgs[i].v3StackOffsetRotFA = XtMasterSlave.v3Tofa(v3ofs[i].v3StackOffsetRot);
                                cfgs[i].v3HandLOffsetFA = XtMasterSlave.v3Tofa(v3ofs[i].v3HandLOffset);
                                cfgs[i].v3HandROffsetFA = XtMasterSlave.v3Tofa(v3ofs[i].v3HandROffset);
                                cfgs[i].v3HandLOffsetRotFA = XtMasterSlave.v3Tofa(v3ofs[i].v3HandLOffsetRot);
                                cfgs[i].v3HandROffsetRotFA = XtMasterSlave.v3Tofa(v3ofs[i].v3HandROffsetRot);
                            }
